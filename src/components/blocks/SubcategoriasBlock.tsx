                    ...
                    {childPages.map((childPage) => (
                      ...
                      >
                        <div className="relative flex flex-col justify-end w-[160px] md:w-[200px] lg:w-[220px] aspect-[4/5] overflow-hidden rounded-2xl cursor-pointer shadow-lg group-hover:shadow-2xl transition-all duration-500 border border-slate-700/50 group-hover:border-blue-500">
                          ...
                          {/* Gradient Overlay - sutil solo en el fondo inferior */}
                          ...
                          <div className="relative z-10 w-full p-3 md:p-4 mt-auto text-center transform group-hover:-translate-y-1 transition-transform duration-300">
                            <h3 className="font-semibold text-white text-xs md:text-sm text-center leading-snug drop-shadow-sm line-clamp-2">
