                        ...
                        >
                          ...
                          >
                            <div className="relative flex flex-col justify-end w-full aspect-[4/5] overflow-hidden rounded-2xl cursor-pointer shadow-lg group-hover:shadow-2xl transition-all duration-500 border border-slate-700/50 group-hover:border-blue-500 group">
                              ...
                              {/* Gradient Overlay - sutil solo en el fondo inferior para que no tape la imagen */}
                              <div className="absolute inset-x-0 bottom-0 h-1/2 bg-gradient-to-t from-slate-950/90 via-slate-950/40 to-transparent opacity-90 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none" />
                              
                              {/* Title - minimalista y limpio */}
                              <div className="relative z-10 w-full p-3 md:p-4 mt-auto text-center transform group-hover:-translate-y-1 transition-transform duration-300">
                                <span className="block font-semibold text-white text-xs md:text-sm leading-snug drop-shadow-sm line-clamp-2">
                                  {childPage.title ? childPage.title.split('|')[0].trim() : ''}
                                </span>
                              </div>
                            </div>
                          </Link>
