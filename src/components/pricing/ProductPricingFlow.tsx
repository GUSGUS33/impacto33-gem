...
const PriceScaleTable = lazy(() => import('./PriceScaleTable'));
const DeliveryTimeSelector = lazy(() => import('./DeliveryTimeSelector').then(m => ({ default: m.DeliveryTimeSelector })));
          ...
          <div className="mt-6">
            ...
            >
              ...
              {pricingData && totalQuantity > 0 && (
                <Suspense fallback={<Skeleton className="h-40 w-full rounded-xl mt-4" />}>
                  <div className="mt-4">
                    <PriceScaleTable
          ...
          <Suspense fallback={<Skeleton className="h-40 w-full rounded-xl" />}>
            <PriceCalculator
              ...
              deliveryTimeSelector={
                <Suspense fallback={<div className="h-32 w-full animate-pulse bg-slate-100 rounded-lg" />}>
                  <DeliveryTimeSelector
