...
export function HeroSlider({ data }: { data: any }) {
  ...
  return (
    <div className="relative mb-32 md:mb-16">
      <section className="relative w-full h-[550px] md:h-[650px] overflow-hidden bg-slate-900">
              ...
              <div className="relative z-20 h-full flex items-center justify-center text-center px-4">
                <div className="max-w-3xl">
                  ...
                  {slide.ctaTexto && slide.ctaUrl && (
                    <Link
                      href={slide.ctaUrl}
                      className="inline-block bg-blue-600 hover:bg-brand text-white font-bold py-3 px-8 rounded-full transition-colors"
                    >
                      {slide.ctaTexto}
                    </Link>
                  )}
