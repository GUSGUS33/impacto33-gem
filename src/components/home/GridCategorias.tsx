      ...
      <div className="container mx-auto px-4 md:px-6">
        {(titulo || subtitulo) && (
          <div className="text-center mb-8 md:mb-10">
            {titulo && <h2 className="text-2xl md:text-3xl font-extrabold text-slate-900 mb-2">{titulo}</h2>}
            {subtitulo && <p className="text-slate-500 text-sm md:text-base max-w-2xl mx-auto">{subtitulo}</p>}
          </div>
        )}

        <div className={`grid grid-cols-3 sm:grid-cols-4 ${gridColsClass} gap-3 sm:gap-6 lg:gap-8 w-full justify-center`}>
