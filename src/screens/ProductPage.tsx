              ...
              <div className="lg:hidden space-y-4">
                <div className="aspect-square bg-white rounded-2xl overflow-hidden border border-slate-100 shadow-sm relative">
                  ...
                  <img 
                    ...
                    alt={product.name}
                    className="w-full h-full object-contain p-4 transition-all duration-300 cursor-pointer"
                      ...
                      <div className="grid grid-cols-2 gap-2.5">
                        {firstFourImages.map((img, idx) => (
                          <button
                            ...
                            className="aspect-square overflow-hidden rounded-lg hover:opacity-90 transition-all relative group"
                          >
                        ...
                        <div className="grid grid-cols-6 gap-2">
                          {remainingImages.map((img, idx) => (
                            <button
                              key={idx + 4}
                              onClick={() => setModalImage(img.sourceUrl)}
                              className="aspect-square rounded-md overflow-hidden hover:opacity-90 transition-all"
                            >
                              <img
                                src={img.sourceUrl}
                                alt={img.altText || product.name}
